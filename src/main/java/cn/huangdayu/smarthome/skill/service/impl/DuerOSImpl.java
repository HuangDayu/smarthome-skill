...
import cn.huangdayu.smarthome.skill.jsonbean.dueros.request.BaiduRequestRoot;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseAdditionalApplianceDetails;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseAdditionalGroupDetails;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseDiscoveredAppliances;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseDiscoveredGroups;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseHeader;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponsePayload;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseRoot;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseTemperature;
import cn.huangdayu.smarthome.skill.jsonbean.dueros.response.DuerOSResponseTemperatureMode;
...
import cn.huangdayu.smarthome.skill.util.DuerOSSkillUtil;
import cn.huangdayu.smarthome.skill.util.SkillDevicesOrderUtil;
import cn.huangdayu.smarthome.skill.util.SkillValueUtil;
import cn.huangdayu.smarthome.skill.util.TypeUtil;
